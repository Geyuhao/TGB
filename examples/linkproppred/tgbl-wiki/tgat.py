...
TGAT
    ...
    - https://github.com/shenyangHuang/TGB/blob/278c653c4504512cfc8b044771eee58bcbe5dfa3/examples/edgeprediction/tgat_LP.py
...
def train():
    r"""
    Training procedure for TGAT model
    ...
    for batch in train_loader:
        ...
        z = model['gnn'](
            z, 
            data.t[edge_index[0]].to(device), 
            edge_index, data.t[e_id].to(device), 
...
optimizer = torch.optim.Adam(
    set(model['gnn'].parameters()) | set(model['link_pred'].parameters()), lr=LR)
